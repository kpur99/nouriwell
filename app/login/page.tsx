      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-md">
          <div className="bg-white border border-[#d4ede2] rounded-2xl p-10">
            <h1 className="text-3xl font-medium text-[#0a2e22] mb-2">Welcome back</h1>
            <p className="text-sm text-[#7aaa94] mb-8">Sign in to your Nouriwell account</p>
            ...
            <p className="text-sm text-center text-[#7aaa94]">
              ...
              <Link href="/signup" className="text-[#1D9E75] font-medium no-underline hover:underline">
                Sign up free
              </Link>
            </p>
          </div>
